...
public class NewsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        ...
        String queryStr = intent.getStringExtra("query");


        Uri baseUri = Uri.parse(NEWS_API_REQUEST_URL);
        Uri.Builder uriBuilder = baseUri.buildUpon();
        uriBuilder.appendQueryParameter("q", queryStr);
        uriBuilder.appendQueryParameter("api-key", "4a17a3fe-9775-4839-825d-3df21d994a38");
